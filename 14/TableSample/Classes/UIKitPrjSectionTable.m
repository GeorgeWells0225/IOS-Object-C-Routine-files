...
- (void)viewDidLoad {
  [super viewDidLoad];
  //创建显示用数据，首先创建段名
  keys_ = [[NSArray alloc] initWithObjects:@"英超", @"西甲", @"意甲", @"德甲", nil];
  //创建各段数据
  NSArray* object1 = [NSArray arrayWithObjects:@"AAA", @"BBB", @"CCC", @"DDD", nil];
  NSArray* object2 = [NSArray arrayWithObjects:@"EEE", @"FFF", nil];
  NSArray* object3 = [NSArray arrayWithObjects:@"GGG", @"HHH", nil];
  NSArray* object4 = [NSArray arrayWithObjects:@"III", @"JJJ", nil];
